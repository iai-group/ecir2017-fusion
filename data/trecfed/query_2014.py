...
From "FW14-topics-evaluation-TREC", outputs all queries in 2014
...
def queryExtract(query_file):
    """
    :query_file: query file storing all queries in FedWeb 2014
    """ 
    ...
    eqname = os.path.join(maindir, "FW14-topics-evaluation-TREC.txt")
    f = open(query_file,"w")
    file = open(eqname)
