...
if __name__ == "__main__":
    ...
    ef = EarlyFusionScorer(index_name, assoc_file, assoc_mode, retr_params, num=1000)
    ef.load_associations()
    query_file = "data/trecblog/query_blog08.txt"
    queries = ef.load_queries(query_file)
    outputfile = "output/blog08/elm_blog08_1.txt"
    ...
    assoc_mode1 = 2
    retr_params = {"lambda": 0.1}
    ef = EarlyFusionScorer(index_name, assoc_file, assoc_mode1, retr_params, num=1000)
    ef.load_associations()
    query_file = "data/trecblog/query_blog08.txt"
    queries = ef.load_queries(query_file)
    outputfile = "output/blog08/elm_blog08_2.txt"
    #e:early-fusion lm:language modeling feb14:federated 14 1:binary
    ef.score_queries(queries, outputfile)
